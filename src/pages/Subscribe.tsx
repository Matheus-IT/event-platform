			...
			<div className="w-full max-w-[1100px] flex items-center justify-between mt-20 mx-auto">
				<div className="max-w-[640px]">
					...
					<p className="mt-4 text-gray-200 leading-relaxed">
						Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum quo officia pariatur a ex dicta beatae
						tempore exercitationem at eius! Beatae ad harum, reprehenderit
					</p>
				</div>
